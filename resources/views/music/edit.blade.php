            ...
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('music.update', ['id' => $music->id]) }}" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <div>
                                <label class="block font-medium text-sm text-gray-700 dark:text-gray-300" for="image">Song Image</label>
                                <input type="file" name="image" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm mt-1 block w-full">
                                <p class="mt-2 text-sm text-gray-500">Upload a new image for the music (optional).</p>
                            </div>
                            <div>
