            ...
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                            <section>
                                ...
                                <form method="POST" action="/music" enctype="multipart/form-data" class="mt-6 space-y-6">
                                    ...
                                    <div>
                                        <label class="block font-medium text-sm text-gray-700 dark:text-gray-300" for="photos">Photos</label>
                                        <input type="file" name="photos[]" multiple class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm mt-1 block w-full" required>
                                    </div>
                                    <div>
